...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 to-white flex flex-col justify-center">
      <Head>
        <title>Inscription | e-motionnel</title>
        <meta name="description" content="Créez votre compte e-motionnel pour commencer à créer des invitations interactives" />
      </Head>
      
      <div className="max-w-md w-full mx-auto px-4 sm:px-6">
        <div className="text-center mb-8">
          <Link href="/" className="inline-block">
            <h1 className="text-3xl font-bold text-indigo-600">e-motionnel</h1>
          </Link>
